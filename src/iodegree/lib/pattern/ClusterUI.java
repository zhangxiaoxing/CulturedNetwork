 ...
 * @author Libra
 */
public class ClusterUI extends javax.swing.JFrame {
...
//            System.out.println("File " + pathToFile + " opened.");
    ...
    private void getActualCluster() {
        ...
        obs = p.clusterCount(conns.getIdList(), type, conns.getObsMap());
    }
    ...
    private void getSimCluster(int genCycle) {
        ...
        for (int cy = 0; cy < genCycle; cy++) {
            countList.add(p.clusterCount(conns.getIdList(), type, conns.getSimMap()));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClusterUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
